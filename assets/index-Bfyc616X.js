...
var Ye = { 0: 1, 2: 6, 4: 7, 3: 5, 1: 0, 6: 2, 7: 4, 5: 3 },
  Xe = class {
...
var q = class e {
    ...
    clamp(e, t) {
      return (
        (this.x = K(this.x, e.x, t.x)), (this.y = K(this.y, e.y, t.y)), this
      );
    }
    clampScalar(e, t) {
...
var St = class e {
  ...
  Lt = class e {
    ...
    setFromQuaternion(e, t, n) {
      return (
        Ft.makeRotationFromQuaternion(e), this.setFromRotationMatrix(Ft, t, n)
      );
    }
...
var Rt = class {
  ...
  en = class e extends Xe {
    ...
    add(e) {
      ...
      return e === this
        ? (G(`Object3D.add: object can't be added as a child of itself.`, e),
          this)
        : (e && e.isObject3D
            ? (e.removeFromParent(),
              (e.parent = this),
    ...
    getWorldQuaternion(e) {
      return (
        this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Wt, e, Gt), e
      );
    }
    getWorldScale(e) {
      return (
        this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Wt, Kt, e), e
      );
    }
    getWorldDirection(e) {
      this.updateWorldMatrix(!0, !1);
...
var Z = class {
    ...
    setRGB(e, t, n, r = X.workingColorSpace) {
      return (
        ...
        (this.g = t),
        (this.b = n),
        X.colorSpaceToWorking(this, r),
        this
      );
    }
    setHSL(e, t, n, r = X.workingColorSpace) {
      if (((e = tt(e, 1)), (t = K(t, 0, 1)), (n = K(n, 0, 1)), t === 0))
    ...
    setColorName(e, t = Me) {
      ...
      return (
        n === void 0 ? W(`Color: Unknown color ` + e) : this.setHex(n, t), this
      );
    }
    clone() {
    ...
    getHex(e = Me) {
      return (
        ...
        Math.round(K(ln.r * 255, 0, 255)) * 65536 +
          Math.round(K(ln.g * 255, 0, 255)) * 256 +
          Math.round(K(ln.b * 255, 0, 255))
      );
    }
    getHexString(e = Me) {
...
var un = class e {
  ...
  Tn = class e {
    ...
    static containsPoint(e, t, n, r) {
      return this.getBarycoord(e, t, n, r, hn) === null
        ? !1
    ...
    static getInterpolation(e, t, n, r, i, a, o, s) {
      return this.getBarycoord(e, t, n, r, hn) === null
        ? ((s.x = 0),
          ...
          null)
        : (s.setScalar(0),
          s.addScaledVector(i, hn.x),
          s.addScaledVector(a, hn.y),
          s.addScaledVector(o, hn.z),
          s);
    }
    static getInterpolatedAttribute(e, t, n, r, i, a) {
      return (
        ...
        Cn.fromBufferAttribute(e, n),
        wn.fromBufferAttribute(e, r),
        a.setScalar(0),
        a.addScaledVector(Sn, i.x),
        a.addScaledVector(Cn, i.y),
    ...
    closestPointToPoint(e, t) {
      ...
      let d = s * u - l * c;
      if (d <= 0 && s >= 0 && l <= 0)
        return (a = s / (s - l)), t.copy(n).addScaledVector(gn, a);
      xn.subVectors(e, i);
      let f = gn.dot(xn),
        p = _n.dot(xn);
      ...
      let m = f * c - s * p;
      if (m <= 0 && c >= 0 && p <= 0)
        return (o = c / (c - p)), t.copy(n).addScaledVector(_n, o);
      let h = l * p - f * u;
      if (h <= 0 && u - l >= 0 && f - p >= 0)
        return (
          vn.subVectors(i, r),
          (o = (u - l) / (u - l + (f - p))),
          t.copy(r).addScaledVector(vn, o)
        );
      let g = 1 / (h + m + d);
      return (
        (a = m * g),
        (o = d * g),
        t.copy(n).addScaledVector(gn, a).addScaledVector(_n, o)
      );
    }
    equals(e) {
  ...
  En = class {
      ...
      if (n !== void 0) {
        ...
        if (t === !0 && r !== void 0 && e.isInstancedMesh !== !0)
          for (let t = 0, n = r.count; t < n; t++)
            e.isMesh === !0
              ? e.getVertexPosition(t, On)
              : On.fromBufferAttribute(r, t),
    ...
    intersectsTriangle(e) {
      ...
      this.getCenter(In),
        Ln.subVectors(this.max, In),
        An.subVectors(e.a, In),
        jn.subVectors(e.b, In),
        Mn.subVectors(e.c, In),
        Nn.subVectors(jn, An),
        Pn.subVectors(Mn, jn),
        Fn.subVectors(An, Mn);
      let t = [
      ...
      return !Bn(t, An, jn, Mn, Ln) ||
        ((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !Bn(t, An, jn, Mn, Ln))
        ? !1
        : (Rn.crossVectors(Nn, Pn),
          (t = [Rn.x, Rn.y, Rn.z]),
          Bn(t, An, jn, Mn, Ln));
    }
    clampPoint(e, t) {
  ...
  Dn = [new J(), new J(), new J(), new J(), new J(), new J(), new J(), new J()],
  On = new J(),
  kn = new En(),
  An = new J(),
  jn = new J(),
...
function Bn(e, t, n, r, i) {
  for (let a = 0, o = e.length - 3; a <= o; a += 3) {
    zn.fromArray(e, a);
    let o = i.x * Math.abs(zn.x) + i.y * Math.abs(zn.y) + i.z * Math.abs(zn.z),
      s = t.dot(zn),
      c = n.dot(zn),
      l = r.dot(zn);
...
var Vn = new J(),
    ...
    union(e) {
      return e.isEmpty()
        ...
        : (this.center.equals(e.center) === !0
            ...
            : (Xn.subVectors(e.center, this.center).setLength(e.radius),
              this.expandByPoint(Yn.copy(e.center).add(Xn)),
              this.expandByPoint(Yn.copy(e.center).sub(Xn))),
          this);
    }
    equals(e) {
  ...
  ar = class e extends Xe {
    ...
    lookAt(e) {
      return (
        er.lookAt(e), er.updateMatrix(), this.applyMatrix4(er.matrix), this
      );
    }
    center() {
      return (
          ...
          for (let e = 0, n = t.length; e < n; e++) {
            ...
            nr.setFromBufferAttribute(n),
              this.morphTargetsRelative
                ? (ir.addVectors(this.boundingBox.min, nr.min),
                  this.boundingBox.expandByPoint(ir),
                  ir.addVectors(this.boundingBox.max, nr.max),
                  this.boundingBox.expandByPoint(ir))
                : (this.boundingBox.expandByPoint(nr.min),
                  this.boundingBox.expandByPoint(nr.max));
          }
        ...
        if ((nr.setFromBufferAttribute(e), t))
          for (let e = 0, n = t.length; e < n; e++) {
            ...
            rr.setFromBufferAttribute(n),
              this.morphTargetsRelative
                ? (ir.addVectors(nr.min, rr.min),
                  nr.expandByPoint(ir),
                  ir.addVectors(nr.max, rr.max),
                  nr.expandByPoint(ir))
                : (nr.expandByPoint(rr.min), nr.expandByPoint(rr.max));
          }
        nr.getCenter(n);
        let r = 0;
        for (let t = 0, i = e.count; t < i; t++)
          ir.fromBufferAttribute(e, t),
            (r = Math.max(r, n.distanceToSquared(ir)));
        if (t)
          for (let i = 0, a = t.length; i < a; i++) {
            let a = t[i],
              o = this.morphTargetsRelative;
            for (let t = 0, i = a.count; t < i; t++)
              ir.fromBufferAttribute(a, t),
                o && (tr.fromBufferAttribute(e, t), ir.add(tr)),
                (r = Math.max(r, n.distanceToSquared(ir)));
          }
    ...
    computeTangents() {
      ...
      this.hasAttribute(`tangent`) === !1 &&
        this.setAttribute(`tangent`, new Wn(new Float32Array(4 * n.count), 4));
    ...
    computeVertexNormals() {
      ...
      if (t !== void 0) {
        ...
        if (n === void 0)
          (n = new Wn(new Float32Array(t.count * 3), 3)),
  ...
  sr = class extends Xe {
    constructor() {
      super(),
        ...
        (this.stencilFail = Ie),
        (this.stencilZFail = Ie),
        (this.stencilZPass = Ie),
        (this.stencilWrite = !1),
  ...
  hr = class {
    ...
    distanceSqToSegment(e, t, n, r) {
      ...
      return (
        ...
        r && r.copy(lr).addScaledVector(ur, d),
        f
      );
    }
    intersectSphere(e, t) {
      cr.subVectors(e.center, this.origin);
      let n = cr.dot(this.direction),
        r = cr.dot(cr) - n * n,
        i = e.radius * e.radius;
      if (r > i) return null;
      let a = Math.sqrt(i - r),
  ...
  Or = class extends en {
      ...
      if (i && o) {
        ...
        for (let n = 0, r = i.length; n < r; n++) {
          ...
          r !== 0 &&
            ...
            a ? Tr.addScaledVector(wr, r) : Tr.addScaledVector(wr.sub(t), r));
        }
        t.add(Tr);
      }
      return t;
    ...
    raycast(e, t) {
      ...
      r !== void 0 &&
        ...
        !(
          yr.containsPoint(vr.origin) === !1 &&
          (vr.intersectSphere(yr, br) === null ||
            vr.origin.distanceToSquared(br) > (e.far - e.near) ** 2)
        ) &&
          (_r.copy(i).invert(),
          vr.copy(e.ray).applyMatrix4(_r),
          !(n.boundingBox !== null && vr.intersectsBox(n.boundingBox) === !1) &&
...
function kr(e, t, n, r, i, a, o, s) {
  ...
  return l < n.near || l > n.far
    ? null
    : { distance: l, point: Dr.clone(), object: e };
}
function Ar(e, t, n, r, i, a, o, s, c, l) {
  e.getVertexPosition(s, xr),
    e.getVertexPosition(c, Sr),
    e.getVertexPosition(l, Cr);
  let u = kr(e, t, n, r, xr, Sr, Cr, Er);
  if (u) {
    let e = new J();
    Tn.getBarycoord(Er, xr, Sr, Cr, e),
      i && (u.uv = Tn.getInterpolatedAttribute(i, s, c, l, e, new q())),
      a && (u.uv1 = Tn.getInterpolatedAttribute(a, s, c, l, e, new q())),
      o &&
        ((u.normal = Tn.getInterpolatedAttribute(o, s, c, l, e, new J())),
        u.normal.dot(r.direction) > 0 && u.normal.multiplyScalar(-1));
    let t = { a: s, b: c, c: l, normal: new J(), materialIndex: 0 };
...
var jr = class extends xt {
  ...
  zr = class {
    ...
    intersectsObject(e) {
      if (e.boundingSphere !== void 0)
        e.boundingSphere === null && e.computeBoundingSphere(),
          Ir.copy(e.boundingSphere).applyMatrix4(e.matrixWorld);
      else {
        let t = e.geometry;
    ...
    intersectsSprite(e) {
      return (
        Ir.center.set(0, 0, 0),
        (Ir.radius = 0.7071067811865476 + Lr.distanceTo(e.center)),
        Ir.applyMatrix4(e.matrixWorld),
        this.intersectsSphere(Ir)
      );
    }
    intersectsSphere(e) {
      let t = this.planes,
  ...
  Jr = class extends en {
    ...
    computeLineDistances() {
      ...
      if (e.index === null) {
        ...
        for (let e = 1, r = t.count; e < r; e++)
          Vr.fromBufferAttribute(t, e - 1),
            Hr.fromBufferAttribute(t, e),
            (n[e] = n[e - 1]),
            (n[e] += Vr.distanceTo(Hr));
    ...
    raycast(e, t) {
      ...
      if (
        ...
        return;
      Ur.copy(r).invert(), Wr.copy(e.ray).applyMatrix4(Ur);
      ...
      if (l !== null) {
        ...
        for (let i = n, a = r - 1; i < a; i += c) {
          let n = l.getX(i),
            r = l.getX(i + 1),
            a = Yr(this, e, Wr, s, n, r, i);
          a && t.push(a);
        }
        if (this.isLineLoop) {
          let i = l.getX(r - 1),
            a = l.getX(n),
            o = Yr(this, e, Wr, s, i, a, r - 1);
          o && t.push(o);
        }
      } else {
        let n = Math.max(0, a.start),
        ...
        for (let i = n, a = r - 1; i < a; i += c) {
          let n = Yr(this, e, Wr, s, i, i + 1, i);
          n && t.push(n);
        }
        if (this.isLineLoop) {
          let i = Yr(this, e, Wr, s, r - 1, n, r - 1);
          i && t.push(i);
        }
      }
    }
...
function Yr(e, t, n, r, i, a, o) {
  ...
  if (
    (Vr.fromBufferAttribute(s, i),
    Hr.fromBufferAttribute(s, a),
    n.distanceSqToSegment(Vr, Hr, Kr, qr) > r)
  )
    return;
  Kr.applyMatrix4(e.matrixWorld);
  let c = t.ray.origin.distanceTo(Kr);
  if (!(c < t.near || c > t.far))
    return {
      distance: c,
      point: qr.clone().applyMatrix4(e.matrixWorld),
      index: o,
      face: null,
      faceIndex: null,
      barycoord: null,
      ...
      if (e.index === null) {
        ...
        for (let e = 0, r = t.count; e < r; e += 2)
          Xr.fromBufferAttribute(t, e),
            Zr.fromBufferAttribute(t, e + 1),
            (n[e] = e === 0 ? 0 : n[e - 1]),
            (n[e + 1] = n[e] + Xr.distanceTo(Zr));
        e.setAttribute(`lineDistance`, new qn(n, 1));
      } else
        W(
  ...
  ai = class extends en {
    ...
    raycast(e, t) {
      ...
      if (
        ...
        ri.applyMatrix4(r),
        (ri.radius += i),
        e.ray.intersectsSphere(ri) === !1)
      )
        return;
      ti.copy(r).invert(), ni.copy(e.ray).applyMatrix4(ti);
      let o = i / ((this.scale.x + this.scale.y + this.scale.z) / 3),
        s = o * o,
        c = n.index,
      ...
      if (c !== null) {
        ...
        for (let a = n, o = i; a < o; a++) {
          let n = c.getX(a);
          ii.fromBufferAttribute(l, n), oi(ii, n, s, r, e, t, this);
        }
      } else {
        let n = Math.max(0, a.start),
          i = Math.min(l.count, a.start + a.count);
        for (let a = n, o = i; a < o; a++)
          ii.fromBufferAttribute(l, a), oi(ii, a, s, r, e, t, this);
      }
    }
    updateMorphTargets() {
      let e = this.geometry.morphAttributes,
...
function oi(e, t, n, r, i, a, o) {
  let s = ni.distanceSqToPoint(e);
  if (s < n) {
    let n = new J();
    ni.closestPointToPoint(e, n), n.applyMatrix4(r);
...
var si = class extends xt {
  ...
  di = class extends xt {
    ...
    constructor(e = 1, t = 1, n = 1, r = 1, i = 1, a = 1) {
      ...
      p(`z`, `y`, `x`, -1, -1, n, t, e, a, i, 0),
        ...
        this.setAttribute(`normal`, new qn(l, 3)),
        this.setAttribute(`uv`, new qn(u, 2));
  ...
  hi = class e extends ar {
    constructor(e = 1, t = 1, n = 1, r = 1) {
      ...
      this.setIndex(f),
        this.setAttribute(`position`, new qn(p, 3)),
        this.setAttribute(`normal`, new qn(m, 3)),
        this.setAttribute(`uv`, new qn(h, 2));
    }
    copy(e) {
      return (
        super.copy(e), (this.parameters = Object.assign({}, e.parameters)), this
  ...
  wi = class extends sr {
    ...
    copy(e) {
      return (
        ...
        (this.uniformsGroups = yi(e.uniformsGroups)),
...
var ki = class {
  ...
  Ai = class extends ki {
    constructor(e, t, n, r) {
      super(e, t, n, r),
        ...
        (this._weightNext = -0),
        (this._offsetNext = -0),
        (this.DefaultSettings_ = { endingStart: H, endingEnd: H });
    }
  ...
  Pi = class {
    constructor(e, t, n, r) {
      ...
      (this.name = e),
        (this.times = Oi(t, this.TimeBufferType)),
        (this.values = Oi(n, this.ValueBufferType)),
    ...
    InterpolantFactoryMethodBezier(e) {
      let t = new Ni(this.times, this.values, this.getValueSize(), e);
    ...
    validate() {
      let e = !0,
        t = this.getValueSize();
      t - Math.floor(t) !== 0 &&
        (G(`KeyframeTrack: Invalid value size in track.`, this), (e = !1));
      let n = this.times,
        r = this.values,
        i = n.length;
      ...
      if (r !== void 0 && Be(r))
        for (let t = 0, n = r.length; t !== n; ++t) {
          let n = r[t];
          if (isNaN(n)) {
            G(`KeyframeTrack: Value is not a valid number.`, this, t, n),
              (e = !1);
            break;
          }
        }
...
(Pi.prototype.ValueTypeName = ``),
  ...
  (Pi.prototype.DefaultInterpolation = Oe);
var Fi = class extends Pi {
  constructor(e, t, n) {
    super(e, t, n);
  }
};
...
(Bi.prototype.ValueTypeName = `string`),
  ...
  (Bi.prototype.DefaultInterpolation = B),
...
var Wi = class extends en {
  ...
  Ji = class {
    ...
    updateMatrices(e) {
      ...
      Ki.setFromMatrixPosition(e.matrixWorld),
        t.position.copy(Ki),
        qi.setFromMatrixPosition(e.target.matrixWorld),
        t.lookAt(qi),
        t.updateMatrixWorld(),
        Gi.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse),
  ...
  Qi = class extends en {
    ...
    updateMatrixWorld(e) {
      super.updateMatrixWorld(e),
        this.matrixWorld.decompose(Yi, Xi, Zi),
        Zi.x === 1 && Zi.y === 1 && Zi.z === 1
          ? this.matrixWorldInverse.copy(this.matrixWorld).invert()
          : this.matrixWorldInverse.compose(Yi, Xi, Zi.set(1, 1, 1)).invert();
    }
    updateWorldMatrix(e, t) {
  ...
  na = class extends Qi {
    ...
    getFocalLength() {
      let e = Math.tan(Qe * 0.5 * this.fov);
      return (0.5 * this.getFilmHeight()) / e;
    }
    getEffectiveFOV() {
      return $e * 2 * Math.atan(Math.tan(Qe * 0.5 * this.fov) / this.zoom);
    }
    getFilmWidth() {
    ...
    getViewBounds(e, t, n) {
      $i.set(-1, -1, 0.5).applyMatrix4(this.projectionMatrixInverse),
        t.set($i.x, $i.y).multiplyScalar(-e / $i.z),
        $i.set(1, 1, 0.5).applyMatrix4(this.projectionMatrixInverse),
        n.set($i.x, $i.y).multiplyScalar(-e / $i.z);
    }
    getViewSize(e, t) {
    ...
    updateProjectionMatrix() {
      let e = this.near,
        t = (e * Math.tan(Qe * 0.5 * this.fov)) / this.zoom,
        n = 2 * t,
        r = this.aspect * n,
        i = -0.5 * r,
        a = this.view;
  ...
  ra = class extends Ji {
    constructor() {
      super(new na(90, 1, 0.5, 500)), (this.isPointLightShadow = !0);
    }
  },
  ia = class extends Wi {
  ...
  ca = class extends en {
    constructor(e, t, n) {
      ...
      let r = new na(oa, sa, e, t);
      (r.layers = this.layers), this.add(r);
      let i = new na(oa, sa, e, t);
      (i.layers = this.layers), this.add(i);
      let a = new na(oa, sa, e, t);
      (a.layers = this.layers), this.add(a);
      let o = new na(oa, sa, e, t);
      (o.layers = this.layers), this.add(o);
      let s = new na(oa, sa, e, t);
      (s.layers = this.layers), this.add(s);
      let c = new na(oa, sa, e, t);
  ...
  pa = `[^` + ua.replace(`\\.`, ``) + `]`,
  ma = `((?:WC+[\\/:])*)`.replace(`WC`, fa),
  ha = `(WCOD+)?`.replace(`WCOD`, pa),
  ga = `(?:\\.(WC+)(?:\\[(.+)\\])?)?`.replace(`WC`, fa),
  _a = `\\.(WC+)(?:\\[(.+)\\])?`.replace(`WC`, fa),
  va = RegExp(`^` + ma + ha + ga + _a + `$`),
  ya = [`material`, `materials`, `bones`, `map`],
  ba = class {
    constructor(e, t, n) {
...
typeof __THREE_DEVTOOLS__ < `u` &&
  __THREE_DEVTOOLS__.dispatchEvent(
    new CustomEvent(`register`, { detail: { revision: `184` } })
  ),
  typeof window < `u` &&
    (window.__THREE__
...
void main() {
  ...
  $ = {
    ...
    lights: {
      ...
      ltc_2: { value: null },
      probesSH: { value: null },
      probesMin: { value: new J() },
      probesMax: { value: new J() },
      probesResolution: { value: new J() },
    },
    points: {
      diffuse: { value: new Z(16777215) },
      opacity: { value: 1 },
  ...
  Ea = {
    ...
    lambert: {
      uniforms: _i([
        ...
        $.fog,
        $.lights,
        { emissive: { value: new Z(0) }, envMapIntensity: { value: 1 } },
      ]),
    ...
    depth: {
      uniforms: _i([$.common, $.displacementmap]),
...
Ea.physical = {
  uniforms: _i([
    Ea.standard.uniforms,
    {
      ...
      attenuationColor: { value: new Z(0) },
      specularColor: { value: new Z(1, 1, 1) },
...
function Aa(e, t, n, r, i, a) {
  ...
  function h(t, n) {
    ...
    i && (i.isCubeTexture || i.mapping === 306)
      ? (l === void 0 &&
          ((l = new Or(
            ...
            new wi({
              ...
              uniforms: gi(Ea.backgroundCube.uniforms),
              vertexShader: Ea.backgroundCube.vertexShader,
              fragmentShader: Ea.backgroundCube.fragmentShader,
              side: 1,
              depthTest: !1,
              depthWrite: !1,
              fog: !1,
        ...
        l.material.uniforms.backgroundRotation.value
          .setFromMatrix4(Oa.makeRotationFromEuler(n.backgroundRotation))
          .transpose(),
        i.isCubeTexture &&
          i.isRenderTargetTexture === !1 &&
          l.material.uniforms.backgroundRotation.value.premultiply(ka),
        (l.material.toneMapped = X.getTransfer(i.colorSpace) !== Fe),
      ...
      : i &&
        ...
        (c === void 0 &&
          ((c = new Or(
            ...
            new wi({
              ...
              uniforms: gi(Ea.background.uniforms),
              vertexShader: Ea.background.vertexShader,
              fragmentShader: Ea.background.fragmentShader,
              side: 0,
              depthTest: !1,
              depthWrite: !1,
              fog: !1,
        ...
        (c.material.toneMapped = X.getTransfer(i.colorSpace) !== Fe),
  ...
  function g(t, r) {
    t.getRGB(Da, bi(e)), n.buffers.color.setClear(Da.r, Da.g, Da.b, r, a);
  }
  function _() {
...
function Na(e, t, n, r) {
  ...
  let l = n.precision === void 0 ? `highp` : n.precision,
    u = c(l);
  u !== l &&
    (W(`WebGLRenderer:`, l, `not supported, using`, u, `instead.`), (l = u));
...
var Fa = 4,
  Ia = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582],
  La = 20,
  Ra = 256,
  za = new aa(),
  Ba = new Z(),
  ...
  Ka = class {
    ...
    fromScene(e, t = 0, n = 0.1, r = 100, i = {}) {
      let { size: a = 256, position: o = Ga } = i;
      (Va = this._renderer.getRenderTarget()),
        (Ha = this._renderer.getActiveCubeFace()),
        (Ua = this._renderer.getActiveMipmapLevel()),
        (Wa = this._renderer.xr.enabled),
    ...
    _cleanup(e) {
      this._renderer.setRenderTarget(Va, Ha, Ua),
        (this._renderer.xr.enabled = Wa),
        (e.scissorTest = !1),
        Ya(e, 0, 0, e.width, e.height);
    }
    _fromTexture(e, t) {
    ...
    _allocateTargets() {
      ...
      if (
        ...
        ({
          ...
          (this._blurMaterial = Za(r, e, t)),
          (this._ggxMaterial = Xa(r, e, t));
      }
      return r;
    }
    _compileMaterial(e) {
    ...
    _textureToCubeUV(e, t) {
      ...
      r
        ? (this._cubemapMaterial === null && (this._cubemapMaterial = $a()),
      ...
      Ya(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, za);
    }
    _applyPMREM(e) {
    ...
    _halfBlur(e, t, n, r, i, a, o) {
      ...
      let u = c.uniforms,
        ...
        f = isFinite(i) ? Math.PI / (2 * d) : (2 * Math.PI) / (2 * La - 1),
        p = i / f,
        m = isFinite(i) ? 1 + Math.floor(3 * p) : La;
      m > La &&
        W(
          `sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${La}`
        );
      let h = [],
        g = 0;
      for (let e = 0; e < La; ++e) {
...
function qa(e) {
  ...
  for (let o = 0; o < a; o++) {
    ...
    t.push(a);
    let s = 1 / a;
    o > e - Fa ? (s = Ia[o - e + Fa - 1]) : o === 0 && (s = 0), n.push(s);
    let c = 1 / (a - 2),
      l = -c,
      u = 1 + c,
    ...
    let h = new ar();
    h.setAttribute(`position`, new Wn(f, 3)),
      h.setAttribute(`uv`, new Wn(p, 2)),
      h.setAttribute(`faceIndex`, new Wn(m, 1)),
      r.push(new Or(h, null)),
      i > Fa && i--;
  }
...
var to = class extends wt {
  constructor(e = 1, t = {}) {
    super(e, e, t), (this.isWebGLCubeRenderTarget = !0);
    let n = { width: e, height: e, depth: 1 },
      r = [n, n, n, n, n, n];
    (this.texture = new si(r)),
...
function ro(e) {
  ...
  return {
    ...
    get: function (e) {
      let t = n(e);
      return (
        t === null && qe(`WebGLRenderer: ` + e + ` extension not supported.`), t
      );
    },
  };
}
...
function so(e, t, n) {
  ...
  function a(a, o, s) {
    ...
    if (d === void 0 || d.count !== u) {
      ...
      (d = { count: u, texture: _, size: new q(p, m) }), r.set(o, d);
      function y() {
...
function uo(e, t, n, r, i) {
  let a = new wt(t, n, {
    ...
    o = new wt(t, n, { type: g, depthBuffer: !1, stencilBuffer: !1 }),
    s = new ar();
  s.setAttribute(`position`, new qn([-1, 3, 0, -1, -1, 0, 3, -1, 0], 3)),
    s.setAttribute(`uv`, new qn([0, 2, 0, 0, 2, 0], 2));
  let c = new Ti({
...
function Vo(e, t, n) {
  ...
  this.type === e.SAMPLER_2D_SHADOW
    ? ((po.compareFunction = n.isReversedDepthBuffer() ? 518 : 515), (a = po))
    : (a = fo),
...
function ss(e, t, n) {
  let r = this.cache,
    i = t.length,
    a = To(n, i);
  Co(r, a) || (e.uniform1iv(this.addr, a), wo(r, a));
  let o;
  o = this.type === e.SAMPLER_2D_SHADOW ? po : fo;
...
function cs(e, t, n) {
  let r = this.cache,
    ...
    a = To(n, i);
  Co(r, a) || (e.uniform1iv(this.addr, a), wo(r, a));
  for (let e = 0; e !== i; ++e) n.setTexture3D(t[e] || ho, a[e]);
}
function ls(e, t, n) {
  let r = this.cache,
    i = t.length,
    a = To(n, i);
  Co(r, a) || (e.uniform1iv(this.addr, a), wo(r, a));
  for (let e = 0; e !== i; ++e) n.setTextureCube(t[e] || go, a[e]);
}
function us(e, t, n) {
  let r = this.cache,
    i = t.length,
    a = To(n, i);
  Co(r, a) || (e.uniform1iv(this.addr, a), wo(r, a));
  for (let e = 0; e !== i; ++e) n.setTexture2DArray(t[e] || mo, a[e]);
}
function ds(e) {
  switch (e) {
    case 5126:
...
function _s(e, t, n) {
  ...
  for (hs.lastIndex = 0; ; ) {
    ...
    if ((c && (s |= 0), l === void 0 || (l === `[` && o + 2 === i))) {
      gs(n, l === void 0 ? new fs(s, e, t) : new ps(s, e, t));
      break;
    } else {
      let e = n.map[s];
      e === void 0 && ((e = new ms(s)), gs(n, e)), (n = e);
    }
  }
}
var vs = class {
  constructor(e, t) {
    ...
    for (let r = 0; r < n; ++r) {
      ...
      _s(n, e.getUniformLocation(t, n.name), this);
    }
    let r = [],
      i = [];
...
var Cs = new Y();
function ws(e) {
  X._getMatrix(Cs, X.workingColorSpace, e);
  let t = `mat3( ${Cs.elements.map((e) => e.toFixed(4))} )`;
  switch (X.getTransfer(e)) {
    ...
    default:
      return (
        W(`WebGLProgram: Unsupported color space: `, e),
...
function As() {
  return (
    X.getLuminanceCoefficients(ks),
    [
      `float luminance( const in vec3 rgb ) {`,
      `	const vec3 weights = vec3( ${ks.x.toFixed(4)}, ${ks.y.toFixed(
        4
      )}, ${ks.z.toFixed(4)} );`,
...
var Gs = { 1: `SHADOWMAP_TYPE_PCF`, 3: `SHADOWMAP_TYPE_VSM` };
function Ks(e) {
  return Gs[e.shadowMapType] || `SHADOWMAP_TYPE_BASIC`;
}
var qs = {
...
function Js(e) {
  return e.envMap === !1
    ? `ENVMAP_TYPE_CUBE`
    : qs[e.envMapMode] || `ENVMAP_TYPE_CUBE`;
}
var Ys = { 302: `ENVMAP_MODE_REFRACTION` };
function Xs(e) {
  return e.envMap === !1
    ? `ENVMAP_MODE_REFLECTION`
    : Ys[e.envMapMode] || `ENVMAP_MODE_REFLECTION`;
}
var Zs = {
...
function Qs(e) {
  return e.envMap === !1
    ...
    : Zs[e.combine] || `ENVMAP_BLENDING_NONE`;
}
function $s(e) {
...
`)),
      (_ = [
        ...
        n.toneMapping === 0 ? `` : Os(`toneMapping`, n.toneMapping),
...
` +
  ...
  let y = v + g + o,
    b = v + _ + s,
    x = ys(i, i.VERTEX_SHADER, y),
    S = ys(i, i.FRAGMENT_SHADER, b);
  i.attachShader(h, x),
    i.attachShader(h, S),
...
` +
        ...
        o === ``
          ? (s === `` || c === ``) && (u = !1)
          : W(`WebGLProgram: Program Info Log:`, o);
      u &&
        (t.diagnostics = {
          runnable: l,
          programLog: o,
    ...
    i.deleteShader(x), i.deleteShader(S), (w = new vs(i, h)), (T = Ns(i, h));
  }
  let w;
  ...
  return (
    (this.isReady = function () {
      return E === !1 && (E = i.getProgramParameter(h, bs)), E;
    }),
  ...
  nc = class {
    ...
    _getShaderStage(e) {
      let t = this.shaderCache,
        n = t.get(e);
      return n === void 0 && ((n = new rc(e)), t.set(e, n)), n;
    }
  },
  rc = class {
    constructor(e) {
      (this.id = tc++), (this.code = e), (this.usedTimes = 0);
    }
  };
function ic(e) {
...
function ac(e, t, n, r, i, a) {
  ...
  function h(i, o, l, u, h, g) {
    ...
    let ee = e.getRenderTarget(),
      ...
      fe = i.sheen > 0,
      R = i.transmission > 0,
      pe = ce && !!i.anisotropyMap,
      me = le && !!i.clearcoatMap,
      he = le && !!i.clearcoatNormalMap,
      ge = le && !!i.clearcoatRoughnessMap,
      _e = de && !!i.iridescenceMap,
      ve = de && !!i.iridescenceThicknessMap,
      ye = fe && !!i.sheenColorMap,
      be = fe && !!i.sheenRoughnessMap,
      xe = !!i.specularMap,
      Se = !!i.specularColorMap,
      Ce = !!i.specularIntensityMap,
      we = R && !!i.transmissionMap,
      Te = R && !!i.thicknessMap,
      Ee = !!i.gradientMap,
      z = !!i.alphaMap,
      De = i.alphaTest > 0,
    ...
    let ke = {
      ...
      packedNormalMap: I && i.normalMapType === 0 && ic(i.normalMap.format),
      metalnessMap: L,
      roughnessMap: se,
      anisotropy: ce,
      anisotropyMap: pe,
      ...
      decodeVideoTexture:
        ...
        X.getTransfer(i.map.colorSpace) === `srgb`,
  ...
  function b(t, n) {
    ...
    return (
      r === void 0
        ? ((r = new ec(e, n, t, i)), l.push(r), u.set(n, r))
        : ++r.usedTimes,
      r
    );
  }
...
function lc() {
  ...
  function u(e, t) {
    n.length > 1 && n.sort(e || sc),
      r.length > 1 && r.sort(t || cc),
      i.length > 1 && i.sort(t || cc);
  }
  function d() {
    ...
    get: function (t) {
      ...
      switch (t.type) {
        ...
        case `SpotLight`:
          ...
          break;
        case `PointLight`:
          n = { position: new J(), color: new Z(), distance: 0, decay: 0 };
          break;
        case `HemisphereLight`:
          n = { direction: new J(), skyColor: new Z(), groundColor: new Z() };
          break;
        case `RectAreaLight`:
          n = {
            color: new Z(),
      ...
      if (((p.camera._reversedDepth = b), p.map === null || v === !0)) {
        if (
          ...
          (p.map = new wt(a.x, a.y, {
            ...
            (p.map.depthTexture = new li(a.x, a.y, h)),
          ...
          d.isPointLight
            ? ((p.map = new to(a.x)), (p.map.depthTexture = new ui(a.x, m)))
            : ((p.map = new wt(a.x, a.y)),
              (p.map.depthTexture = new li(a.x, a.y, m))),
      ...
      for (let t = 0; t < x; t++) {
        ...
        if (d.isPointLight) {
          ...
          r !== e.far && ((e.far = r), e.updateProjectionMatrix()),
            Cc.setFromMatrixPosition(d.matrixWorld),
            e.position.copy(Cc),
            wc.copy(e.position),
            wc.add(bc[t]),
            e.up.copy(xc[t]),
...
function Ec(e, t) {
  ...
  let oe = {};
  (oe[e.TEXTURE_2D] = ae(e.TEXTURE_2D, e.TEXTURE_2D, 1)),
    (oe[e.TEXTURE_CUBE_MAP] = ae(
      e.TEXTURE_CUBE_MAP,
      e.TEXTURE_CUBE_MAP_POSITIVE_X,
      6
    )),
    (oe[e.TEXTURE_2D_ARRAY] = ae(e.TEXTURE_2D_ARRAY, e.TEXTURE_2D_ARRAY, 1, 1)),
    (oe[e.TEXTURE_3D] = ae(e.TEXTURE_3D, e.TEXTURE_3D, 1, 1)),
    a.setClear(0, 0, 0, 1),
    o.setClear(1),
    s.setClear(0),
    L(e.DEPTH_TEST),
  ...
  function R(t, n, r, i, a, o, s, c, l, u) {
    ...
    (a ||= n),
      ...
      (s ||= i),
      (n !== v || a !== x) &&
        (e.blendEquationSeparate(de[n], de[a]), (v = n), (x = a)),
      (r !== y || i !== b || o !== S || s !== C) &&
...
function Dc(l, u, d, f, p, m, h) {
  ...
  function L(e, t) {
    ...
    if (
      ...
      let r = e.image;
      if (r === null)
        W(`WebGLRenderer: Texture marked for update but no image data found.`);
  ...
  let ue = { [e]: l.REPEAT, [t]: l.CLAMP_TO_EDGE, [n]: l.MIRRORED_REPEAT },
    de = {
      [r]: l.NEAREST,
  ...
  function R(e, t) {
    if (
      ...
      l.texParameteri(e, l.TEXTURE_WRAP_S, ue[t.wrapS]),
      l.texParameteri(e, l.TEXTURE_WRAP_T, ue[t.wrapT]),
      (e === l.TEXTURE_3D || e === l.TEXTURE_2D_ARRAY) &&
        l.texParameteri(e, l.TEXTURE_WRAP_R, ue[t.wrapR]),
      l.texParameteri(e, l.TEXTURE_MAG_FILTER, de[t.magFilter]),
      l.texParameteri(e, l.TEXTURE_MIN_FILTER, de[t.minFilter]),
      t.compareFunction &&
        (l.texParameteri(e, l.TEXTURE_COMPARE_MODE, l.COMPARE_REF_TO_TEXTURE),
        l.texParameteri(e, l.TEXTURE_COMPARE_FUNC, fe[t.compareFunction])),
    ...
    if (i.length === 0)
      ...
      for (let e = 1; e < i.length; e++) {
        let n = i[a],
          r = i[e],
          o = n.start + n.count,
          s = me(r.start, t.width, 4),
          c = me(n.start, t.width, 4);
        r.start <= o + 1 &&
        s === c &&
        me(r.start + r.count - 1, t.width, 4) === s
          ? (n.count = Math.max(n.count, r.start + r.count - n.start))
          : (++a, (i[a] = r));
      }
      i.length = a + 1;
  ...
  function ge(e, t, n) {
    ...
    if (a.version !== o.__version || i === !0) {
      if (
        ...
        let e = X.getPrimaries(X.workingColorSpace),
          n = t.colorSpace === `` ? null : X.getPrimaries(t.colorSpace),
      ...
      if (t.isDepthTexture)
                ...
                if (g) {
                  if (v)
                    if (t.layerUpdates.size > 0) {
                      let e = Sa(f.width, f.height, t.format, t.type);
        ...
        if (g) {
          if (
            ...
            if (t.layerUpdates.size > 0) {
              let n = Sa(e.width, e.height, t.format, t.type);
              for (let r of t.layerUpdates) {
        ...
        if (`texElementImage2D` in l) {
          ...
          let r = l.RGBA,
            i = l.RGBA,
            a = l.UNSIGNED_BYTE;
          l.texElementImage2D(l.TEXTURE_2D, 0, r, i, a, e),
  ...
  function _e(e, t, n) {
    ...
    if (i.version !== a.__version || r === !0) {
      d.activeTexture(l.TEXTURE0 + n);
      let e = X.getPrimaries(X.workingColorSpace),
        o = t.colorSpace === `` ? null : X.getPrimaries(t.colorSpace),
    ...
    if (
      ...
      if (
        ...
        (i.__webglTexture = l.createTexture()),
          ...
          R(l.TEXTURE_CUBE_MAP, t.depthTexture);
  ...
  function xe(e) {
    ...
    if (e.depthTexture && !t.__autoAllocateDepthBuffer)
      if (n) for (let n = 0; n < 6; n++) be(t.__webglFramebuffer[n], e, n);
        ...
        n && n.length > 0
          ? be(t.__webglFramebuffer[0], e, 0)
          : be(t.__webglFramebuffer, e, 0);
      }
    else if (n) {
      ...
      if (e.samples > 0 && B(e) === !1) {
        ...
        l.bindRenderbuffer(l.RENDERBUFFER, null),
          e.depthBuffer &&
            ...
            ye(n.__webglDepthRenderbuffer, e, !0)),
          d.bindFramebuffer(l.FRAMEBUFFER, null);
      }
    }
    if (a) {
      ...
      for (let t = 0, r = i.length; t < r; t++) {
        ...
        (e.isWebGL3DRenderTarget || e.isWebGLArrayRenderTarget) &&
          ...
          R(o, r),
          ve(n.__webglFramebuffer, e, r, l.COLOR_ATTACHMENT0 + t, o, 0),
          D(r) && O(o);
      }
      d.unbindTexture();
    } else {
      ...
      if (
        ...
        for (let r = 0; r < t.mipmaps.length; r++)
          ve(n.__webglFramebuffer[r], e, t, l.COLOR_ATTACHMENT0, i, r);
        ...
        for (let c = 0; c < t.length; c++) {
          ...
          l.blitFramebuffer(0, 0, n, r, 0, 0, n, r, i, l.NEAREST),
            _ === !0 &&
              ((Te.length = 0),
              (Ee.length = 0),
              Te.push(l.COLOR_ATTACHMENT0 + c),
              e.depthBuffer &&
                e.resolveDepthBuffer === !1 &&
                (Te.push(a),
                Ee.push(a),
                l.invalidateFramebuffer(l.DRAW_FRAMEBUFFER, Ee)),
              l.invalidateFramebuffer(l.READ_FRAMEBUFFER, Te));
        }
        if (
  ...
  (this.allocateTextureUnit = ae),
    (this.resetTextureUnits = re),
    (this.getTextureUnits = ie),
    (this.setTextureUnits = I),
    (this.setTexture2D = L),
  ...
  jc = class {
    ...
    getMesh(e) {
      if (this.texture !== null && this.mesh === null) {
        ...
        this.mesh = new Or(new hi(20, 20), n);
      }
      return this.mesh;
    }
    reset() {
    ...
    constructor(e, t) {
      ...
      (this.cameraAutoUpdate = !0),
        ...
        (this.getController = function (e) {
          let t = C[e];
          return (
            t === void 0 && ((t = new rn()), (C[e] = t)), t.getTargetRaySpace()
          );
        }),
      ...
      function oe(e, t, n) {
        n === null
          ...
          e.isPerspectiveCamera &&
            ((e.fov = $e * 2 * Math.atan(1 / e.projectionMatrix.elements[5])),
            (e.zoom = 1));
      }
...
function Fc(e, t) {
  ...
  function r(t, n) {
    n.color.getRGB(t.fogColor.value, bi(e)),
      n.isFog
  ...
  function a(e, r) {
    ...
    a &&
      ...
      e.envMapRotation.value
        .setFromMatrix4(Nc.makeRotationFromEuler(o))
        .transpose(),
      a.isCubeTexture &&
        ...
        if (p(i, t, r, a) === !0) {
          ...
          for (let a = 0; a < n.length; a++) {
            ...
            typeof o == `number` || typeof o == `boolean`
              ...
              ? i.__data.set(
                  new o.constructor(o.buffer, o.byteOffset, i.__data.length)
                )
...
var Bc = class {
    constructor(e = {}) {
      ...
      try {
        ...
        if (
          (`setAttribute` in t &&
            t.setAttribute(`data-engine`, `three.js r184`),
      ...
      function Qe() {
        (B = new ro(z)),
          ...
          (Oe = new Na(z, B, e, Ye)),
          (V = new Ec(z, B)),
          Oe.reversedDepthBuffer && h && V.buffers.depth.setReversed(!0),
          (ke = new oo(z)),
          (H = new oc()),
          (U = new Dc(z, B, V, H, Oe, Ye, ke)),
          (Ae = new no(F)),
          (je = new Ta(z)),
          (Xe = new ja(z, je)),
          (Ne = new io(z, je, ke, Xe)),
          (Pe = new co(z, Ne, je, Xe, ke)),
          (We = new so(z, Oe, U)),
          (Be = new Pa(H)),
          (Fe = new ac(F, Ae, B, Oe, Xe, Be)),
          (Ie = new Fc(F, H)),
          (Le = new uc()),
          (ze = new _c(B)),
          (Ue = new Aa(F, Ae, V, Pe, x, s)),
          (Ve = new Tc(F, Pe, Oe)),
          (Ze = new Ic(z, ke, Oe, V)),
          (Ke = new Ma(z, B, ke)),
          (qe = new ao(z, B, ke)),
      ...
      Qe(), S !== 1009 && (P = new uo(S, t.width, t.height, r, i));
      let $e = new Mc(F, z);
      (this.xr = $e),
        ...
        (this.setViewport = function (e, t, n, r) {
          e.isVector4 ? he.set(e.x, e.y, e.z, e.w) : he.set(e, t, n, r),
            V.viewport(L.copy(he).multiplyScalar(R).round());
        }),
        (this.getScissor = function (e) {
          return e.copy(ge);
        }),
        (this.setScissor = function (e, t, n, r) {
          e.isVector4 ? ge.set(e.x, e.y, e.z, e.w) : ge.set(e, t, n, r),
            V.scissor(se.copy(ge).multiplyScalar(R).round());
        }),
            ...
            if (e) {
              ...
              t
                ? ((T[0] = i),
                  ...
                  (T[2] = o),
                  (T[3] = r),
                  z.clearBufferuiv(z.COLOR, 0, T))
                : ((E[0] = i),
                  (E[1] = a),
                  (E[2] = o),
                  (E[3] = r),
                  z.clearBufferiv(z.COLOR, 0, E));
            } else r |= z.COLOR_BUFFER_BIT;
          }
          t &&
            ((r |= z.DEPTH_BUFFER_BIT), this.state.buffers.depth.setMask(!0)),
            n &&
              ((r |= z.STENCIL_BUFFER_BIT),
        ...
        (this.dispose = function () {
          t.removeEventListener(`webglcontextlost`, et, !1),
            ...
            Fe.dispose(),
            $e.dispose(),
            $e.removeEventListener(`sessionstart`, st),
            $e.removeEventListener(`sessionend`, Y),
            ct.stop();
        });
      function et(e) {
      ...
      this.renderBufferDirect = function (e, t, n, r, i, a) {
        ...
        let h,
          g = Ke;
        if (
          (c !== null && ((h = je.get(c)), (g = qe), g.setIndex(h)), i.isMesh)
        )
          r.wireframe === !0
            ? (V.setLineWidth(r.wireframeLinewidth * Ee()), g.setMode(z.LINES))
          ...
          i.isPoints
            ? g.setMode(z.POINTS)
            : i.isSprite && g.setMode(z.TRIANGLES);
        if (i.isBatchedMesh)
          if (B.get(`WEBGL_multi_draw`))
            g.renderMultiDraw(
              i._multiDrawStarts,
              i._multiDrawCounts,
              i._multiDrawCount
            ...
            for (let r = 0; r < n; r++)
              o.setValue(z, `_gl_DrawID`, r), g.render(e[r] / a, t[r]);
          }
      ...
      (this.compile = function (e, t, n = null) {
        ...
        (this.compileAsync = function (e, t, n = null) {
          ...
          return new Promise((t) => {
            ...
            B.get(`KHR_parallel_shader_compile`) === null
              ? setTimeout(n, 10)
              : n();
          });
        });
      ...
      let ct = new wa();
      ct.setAnimationLoop(ot),
        typeof self < `u` && ct.setContext(self),
        (this.setAnimationLoop = function (e) {
          (at = e), $e.setAnimationLoop(e), e === null ? ct.stop() : ct.start();
        }),
        $e.addEventListener(`sessionstart`, st),
        $e.addEventListener(`sessionend`, Y),
        (this.render = function (e, t) {
          ...
          if (
            ...
            $e.enabled === !0 &&
              ...
              ($e.cameraAutoUpdate === !0 && $e.updateCamera(t),
              (t = $e.getCamera())),
            e.isScene === !0 && e.onBeforeRender(F, e, t, I),
            (j = ze.get(e, N.length)),
            j.init(t),
            (j.state.textureUnits = U.getTextureUnits()),
            N.push(j),
            xe.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse),
            ve.setFromProjectionMatrix(xe, Re, t.reversedDepth),
            (be = this.localClippingEnabled),
            (ye = Be.init(this.clippingPlanes, be)),
            (k = Le.get(e, M.length)),
            k.init(),
            M.push(k),
            ...
            e !== null && lt(e, t, -1 / 0, F.sortObjects);
          }
          lt(e, t, 0, F.sortObjects),
            k.finish(),
            F.sortObjects === !0 && k.sort(pe, me),
            (Te =
              $e.enabled === !1 ||
              $e.isPresenting === !1 ||
              $e.hasDepthSensing() === !1),
            Te && Ue.addToRenderList(k, e),
            this.info.render.frame++,
            ye === !0 && Be.beginShadows();
          ...
          if (
            ...
            if ((j.setupLights(), t.isArrayCamera)) {
              ...
              r.length > 0 && dt(n, r, e, t), Te && Ue.render(e), ut(k, e, t);
          }
          I !== null &&
            ie === 0 &&
            ...
            N.length > 0
              ? ((j = N[N.length - 1]),
                U.setTextureUnits(j.state.textureUnits),
                ye === !0 &&
                  Be.setGlobalState(F.clippingPlanes, j.state.camera))
              : (j = null),
            M.pop(),
      ...
      function lt(e, t, n, r) {
        ...
        if (e.layers.test(t.layers)) {
          if (e.isGroup) n = e.renderOrder;
            ...
            (!e.frustumCulled || ve.intersectsObject(e))
          ) {
            let t = Pe.update(e),
              i = e.material;
            if (
              (r &&
                ...
                Ce.applyMatrix4(e.matrixWorld).applyMatrix4(xe)),
              Array.isArray(i))
            ) {
              let r = t.groups;
      ...
      function ut(e, t, n, r) {
        ...
        j.setupLightsView(n),
          ye === !0 && Be.setGlobalState(F.clippingPlanes, n),
          r && V.viewport(L.copy(r)),
          i.length > 0 && ft(i, t, n),
          a.length > 0 && ft(a, t, n),
          o.length > 0 && ft(o, t, n),
      ...
      function dt(e, t, n, r) {
        ...
        F.setRenderTarget(a),
          F.getClearColor(le),
          (ue = F.getClearAlpha()),
          ue < 1 && F.setClearColor(16777215, 0.5),
          F.clear(),
          Te && Ue.render(n);
        let f = F.toneMapping;
        F.toneMapping = 0;
        ...
        if (
          ...
          j.setupLightsView(r),
          ye === !0 && Be.setGlobalState(F.clippingPlanes, r),
          ft(e, n, r),
      ...
      function ft(e, t, n) {
        ...
        for (let i = 0, a = e.length; i < a; i++) {
          ...
          l.allowOverride === !0 && r !== null && (l = r),
            o.layers.test(n.layers) && pt(o, t, n, s, l, c);
        }
      }
      ...
      function ht(e) {
        if (e.uniformsList === null) {
          ...
          e.uniformsList = vs.seqWithValue(t.seq, e.uniforms);
        }
      ...
      function vt(e, t, n, r, i) {
        ...
        if (S || oe !== e) {
          V.buffers.depth.getReversed() &&
            ...
            T.setValue(z, `projectionMatrix`, e.projectionMatrix),
            T.setValue(z, `viewMatrix`, e.matrixWorldInverse);
          let t = T.map.cameraPosition;
          t !== void 0 &&
            t.setValue(z, Se.setFromMatrixPosition(e.matrixWorld)),
            ...
            (r.isMeshPhongMaterial ||
              ...
              r.isMeshStandardMaterial ||
              r.isShaderMaterial) &&
              T.setValue(z, `isOrthographic`, e.isOrthographicCamera === !0),
            oe !== e && ((oe = e), (C = !0), (w = !0));
        }
        if (
          (v.needsLights &&
            ...
            y.state.spotShadowMap.length > 0 &&
              T.setValue(z, `spotShadowMap`, y.state.spotShadowMap, U),
            y.state.pointShadowMap.length > 0 &&
              T.setValue(z, `pointShadowMap`, y.state.pointShadowMap, U)),
          i.isSkinnedMesh)
        ) {
          T.setOptional(z, i, `bindMatrix`),
            T.setOptional(z, i, `bindMatrixInverse`);
          let e = i.skeleton;
          e &&
            (e.boneTexture === null && e.computeBoneTexture(),
            T.setValue(z, `boneTexture`, e.boneTexture, U));
        }
        i.isBatchedMesh &&
          (T.setOptional(z, i, `batchingTexture`),
          T.setValue(z, `batchingTexture`, i._matricesTexture, U),
          T.setOptional(z, i, `batchingIdTexture`),
          T.setValue(z, `batchingIdTexture`, i._indirectTexture, U),
          T.setOptional(z, i, `batchingColorTexture`),
          i._colorsTexture !== null &&
            T.setValue(z, `batchingColorTexture`, i._colorsTexture, U));
        ...
        if (
          ...
          E.dfgLUT !== void 0 && (E.dfgLUT.value = zc()),
          C)
        ) {
          if (
            (T.setValue(z, `toneMappingExposure`, F.toneMappingExposure),
            v.needsLights && yt(E, w),
          ...
          vs.upload(z, ht(v), E, U);
        }
        if (
          (r.isShaderMaterial &&
            r.uniformsNeedUpdate === !0 &&
            (vs.upload(z, ht(v), E, U), (r.uniformsNeedUpdate = !1)),
          r.isSpriteMaterial && T.setValue(z, `center`, i.center),
          T.setValue(z, `modelViewMatrix`, i.modelViewMatrix),
          T.setValue(z, `normalMatrix`, i.normalMatrix),
          T.setValue(z, `modelMatrix`, i.matrixWorld),
      ...
      (this.getActiveCubeFace = function () {
        ...
        (this.setRenderTargetTextures = function (e, t, n) {
          ...
          (r.__autoAllocateDepthBuffer = e.resolveDepthBuffer === !1),
            ...
            (H.get(e.depthTexture).__webglTexture = r.__autoAllocateDepthBuffer
              ? void 0
              : n),
      ...
      (this.setRenderTarget = function (e, t = 0, n = 0) {
        ...
        if (e) {
          ...
          if (o.__useDefaultFramebuffer !== void 0) {
            V.bindFramebuffer(z.FRAMEBUFFER, o.__webglFramebuffer),
              L.copy(e.viewport),
              se.copy(e.scissor),
              (ce = e.scissorTest),
              V.viewport(L),
          ...
          L.copy(he).multiplyScalar(R).floor(),
            se.copy(ge).multiplyScalar(R).floor(),
            (ce = _e);
        if (
          (n !== 0 && (r = xt),
          V.bindFramebuffer(z.FRAMEBUFFER, r) && V.drawBuffers(e, r),
          V.viewport(L),
          V.scissor(se),
          V.setScissorTest(ce),
          i)
          ...
          if ((e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c)) {
            ...
            try {
              let o = e.textures[s],
                ...
                l = o.type;
              if (
                (e.textures.length > 1 && z.readBuffer(z.COLOR_ATTACHMENT0 + s),
              ...
              t >= 0 &&
                ...
                n >= 0 &&
                n <= e.height - i &&
                z.readPixels(t, n, r, i, Ye.convert(c), Ye.convert(l), a);
            } finally {
        ...
        (this.readRenderTargetPixelsAsync = async function (
          ...
          if ((e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c))
            if (t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i) {
              ...
              z.bindBuffer(z.PIXEL_PACK_BUFFER, d),
                z.bufferData(z.PIXEL_PACK_BUFFER, a.byteLength, z.STREAM_READ),
                z.readPixels(t, n, r, i, Ye.convert(l), Ye.convert(u), 0);
      ...
      let Ct = z.createFramebuffer(),
        Tt = z.createFramebuffer();
      (this.copyTextureToTexture = function (
        ...
        r === null
          ? ((f = 0), (p = 0), (m = 0))
          : ((f = r.x), (p = r.y), (m = r.z));
        let g = Ye.convert(t.format),
          _ = Ye.convert(t.type),
          v;
        t.isData3DTexture
          ? (U.setTexture3D(t, 0), (v = z.TEXTURE_3D))
          : t.isDataArrayTexture || t.isCompressedArrayTexture
          ? (U.setTexture2DArray(t, 0), (v = z.TEXTURE_2D_ARRAY))
          : (U.setTexture2D(t, 0), (v = z.TEXTURE_2D)),
          V.activeTexture(z.TEXTURE0),
          V.pixelStorei(z.UNPACK_FLIP_Y_WEBGL, t.flipY),
          V.pixelStorei(z.UNPACK_PREMULTIPLY_ALPHA_WEBGL, t.premultiplyAlpha),
          V.pixelStorei(z.UNPACK_ALIGNMENT, t.unpackAlignment);
        let y = V.getParameter(z.UNPACK_ROW_LENGTH),
          b = V.getParameter(z.UNPACK_IMAGE_HEIGHT),
          x = V.getParameter(z.UNPACK_SKIP_PIXELS),
          S = V.getParameter(z.UNPACK_SKIP_ROWS),
          C = V.getParameter(z.UNPACK_SKIP_IMAGES);
        V.pixelStorei(z.UNPACK_ROW_LENGTH, h.width),
          V.pixelStorei(z.UNPACK_IMAGE_HEIGHT, h.height),
          V.pixelStorei(z.UNPACK_SKIP_PIXELS, l),
          V.pixelStorei(z.UNPACK_SKIP_ROWS, u),
          V.pixelStorei(z.UNPACK_SKIP_IMAGES, d);
        ...
        if (e.isDepthTexture) {
          ...
          V.bindFramebuffer(z.READ_FRAMEBUFFER, h.__webglFramebuffer),
            V.bindFramebuffer(z.DRAW_FRAMEBUFFER, g.__webglFramebuffer);
          for (let n = 0; n < c; n++)
            w &&
              (z.framebufferTextureLayer(
                z.READ_FRAMEBUFFER,
          ...
          V.bindFramebuffer(z.READ_FRAMEBUFFER, null),
            V.bindFramebuffer(z.DRAW_FRAMEBUFFER, null);
        } else if (i !== 0 || e.isRenderTargetTexture || H.has(e)) {
          let n = H.get(e),
            r = H.get(t);
          V.bindFramebuffer(z.READ_FRAMEBUFFER, Ct),
            V.bindFramebuffer(z.DRAW_FRAMEBUFFER, Tt);
          for (let e = 0; e < c; e++)
            w
              ? z.framebufferTextureLayer(
                  z.READ_FRAMEBUFFER,
              ...
              i === 0
                ? T
                  ? z.copyTexSubImage3D(v, a, f, p, m + e, l, u, o, s)
                  : z.copyTexSubImage2D(v, a, f, p, l, u, o, s)
                : z.blitFramebuffer(
                    l,
                    u,
                    o,
          ...
          T
            ? e.isDataTexture || e.isData3DTexture
              ? z.texSubImage3D(v, a, f, p, m, o, s, c, g, _, h.data)
              : t.isCompressedArrayTexture
              ? z.compressedTexSubImage3D(v, a, f, p, m, o, s, c, g, h.data)
              : z.texSubImage3D(v, a, f, p, m, o, s, c, g, _, h)
            : e.isDataTexture
            ? z.texSubImage2D(z.TEXTURE_2D, a, f, p, o, s, g, _, h.data)
            ...
            : z.texSubImage2D(z.TEXTURE_2D, a, f, p, o, s, g, _, h);
        V.pixelStorei(z.UNPACK_ROW_LENGTH, y),
          V.pixelStorei(z.UNPACK_IMAGE_HEIGHT, b),
          V.pixelStorei(z.UNPACK_SKIP_PIXELS, x),
          V.pixelStorei(z.UNPACK_SKIP_ROWS, S),
          V.pixelStorei(z.UNPACK_SKIP_IMAGES, C),
          a === 0 && t.generateMipmaps && z.generateMipmap(v),
          V.unbindTexture();
      }),
  ...
  Vc = document.querySelector(`#space-canvas`),
  Hc = window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,
  Uc = new dn();
Uc.fog = new un(131594, 0.0012);
var Wc = new na(72, 1, 0.1, 2200);
Wc.position.set(0, 0, 120);
var Gc = new Bc({
  canvas: Vc,
  alpha: !0,
  antialias: !0,
...
Gc.setClearColor(0, 1), Gc.setPixelRatio(1);
var Kc = window.innerWidth < 720,
  qc = Kc ? 1400 : 2200,
  Jc = Kc ? 240 : 380,
  Yc = Kc ? 9 : 12,
  Xc = Kc ? 220 : 360,
  ...
  rl = 0,
  il = 0;
(window.__spaceWarpBoost ??= 0),
  (window.__spacefieldStatus = { frames: 0, running: !0 }),
  (Vc.dataset.spacefield = `running`),
  (Vc.dataset.frames = `0`);
function al(e, t) {
...
function ol() {
  ...
  let t = e.getContext(`2d`),
    n = t.createRadialGradient(48, 48, 0, 48, 48, 48);
  return (
    n.addColorStop(0, `rgba(255,255,255,1)`),
    n.addColorStop(0.28, `rgba(210,218,255,0.88)`),
    n.addColorStop(0.58, `rgba(142,156,255,0.32)`),
...
var sl = ol(),
  cl = (() => {
    let e = new Float32Array(qc * 3),
      t = new Float32Array(qc * 3),
      n = new Float32Array(qc);
    function r(r, i = !1) {
      let a = r * 3,
        o = Math.random() * Math.PI * 2,
        s = Math.random() ** 0.64 * al(120, 920);
      (e[a] = Math.cos(o) * s),
        (e[a + 1] = Math.sin(o) * s * al(0.56, 1.16)),
        (e[a + 2] = i ? al(-1500, 130) : -1500),
        (n[r] = al(2.4, 9.2));
      let c = Math.random();
      (t[a] = c > 0.76 ? 0.68 : 0.92),
        (t[a + 1] = c > 0.76 ? 0.72 : 0.94),
        (t[a + 2] = 1);
    }
    for (let e = 0; e < qc; e += 1) r(e, !0);
    let i = new ar();
    i.setAttribute(`position`, new Wn(e, 3)),
      i.setAttribute(`color`, new Wn(t, 3));
    let a = new ai(
      i,
      new ei({
        map: sl,
    ...
    return (
      Uc.add(a), { geometry: i, mesh: a, positions: e, reset: r, speeds: n }
    );
  })(),
  ll = (() => {
    let e = new Float32Array(Jc * 2 * 3),
      t = new Float32Array(Jc * 2 * 3),
      n = new Float32Array(Jc);
    function r(r, i = !1) {
      let a = r * 6,
        o = r * 6,
        s = Math.random() * Math.PI * 2,
        c = Math.random() ** 0.58 * al(180, 980),
        l = Math.cos(s) * c,
        u = Math.sin(s) * c * al(0.52, 1.08),
        d = i ? al(-1500, 150) : -1500,
        f = al(56, 210);
      (e[a] = l),
        (e[a + 1] = u),
        (e[a + 2] = d),
...
for (let e = 0; e < Yc; e += 1) {
  let t = 108 + e * 58,
    n = new mi(0, 0, t * 1.9, t, 0, Math.PI * 2),
    r = new $r(new ar().setFromPoints(n.getPoints(96)), dl);
  (r.position.z = -e * 92 - 120), (r.rotation.z = e * 0.18), ul.add(r);
}
(ul.rotation.x = 0.16), (ul.rotation.y = -0.1), Uc.add(ul);
var fl = (() => {
    let e = new Float32Array(Xc * 3),
      t = new Float32Array(Xc * 3);
    for (let n = 0; n < Xc; n += 1) {
      let r = n * 3,
        i = Math.random() * Math.PI * 2,
        a = Math.random() ** 0.72 * al(280, 980);
      (e[r] = Math.cos(i) * a),
        (e[r + 1] = Math.sin(i) * a * 0.62),
        (e[r + 2] = al(-1500, -80));
      let o = Math.random() > 0.48;
      (t[r] = o ? 0.62 : 0.78), (t[r + 1] = o ? 0.55 : 0.72), (t[r + 2] = 1);
    }
    let n = new ar();
    n.setAttribute(`position`, new Wn(e, 3)),
      n.setAttribute(`color`, new Wn(t, 3));
    let r = new ai(
      n,
      new ei({
        map: sl,
  ...
  pl = new ia(12167167, 2.6, 940);
pl.position.set(0, 0, 80), Uc.add(pl);
function ml() {
...
function hl(e) {
  (Zc.x = (e.clientX / window.innerWidth - 0.5) * 2),
    (Zc.y = (e.clientY / window.innerHeight - 0.5) * 2);
}
function gl() {
  let e = Math.abs(window.scrollY - el);
  (el = window.scrollY), ($c = Math.max($c, Math.min(7, e * 0.022)));
}
function _l(e = performance.now()) {
  rl = requestAnimationFrame(_l);
  let t = Math.min(2.2, Math.max(0.35, (e - tl) / 16.67 || 1));
  (tl = e),
    (nl = performance.now()),
    (il += 1),
    (window.__spacefieldStatus = { frames: il, running: !0 }),
    il % 12 == 0 && (Vc.dataset.frames = String(il)),
    gl(),
    ($c *= 0.9 ** t);
  let n = window.__spaceWarpBoost ?? 0,
    r = 1 + Math.sin(e * 0.0018) * 0.08,
    i = 2.35 + $c + n * 1.9,
    a = cl.geometry.attributes.position,
    o = ll.geometry.attributes.position;
  for (let e = 0; e < qc; e += 1) {
    let n = e * 3;
    (cl.positions[n + 2] += cl.speeds[e] * i * t * Qc),
      cl.positions[n + 2] > 150 && cl.reset(e);
  }
  for (let e = 0; e < Jc; e += 1) {
    let r = e * 6,
      i = ll.speeds[e] * (1.42 + $c * 0.62 + n * 0.34) * t * Qc;
    (ll.positions[r + 2] += i),
      (ll.positions[r + 5] += i),
      ll.positions[r + 2] > 170 && ll.reset(e);
  }
  (a.needsUpdate = !0), (o.needsUpdate = !0);
  let s = e * 22e-5;
  (cl.mesh.rotation.z = s),
    (ll.mesh.rotation.z = s * 1.7),
    (ul.rotation.z = -s * 2.4),
    ul.children.forEach((e, i) => {
      e.type === `LineLoop` &&
        ((e.position.z += (2.35 + $c * 0.52 + n * 0.72) * t * Qc),
        (e.rotation.z += (0.0032 + i * 6e-5) * t * Qc),
        e.scale.setScalar(r),
        e.position.z > 130 && (e.position.z = -Yc * 92));
    }),
    (fl.rotation.z = s * 0.48),
    (fl.rotation.y = Math.sin(e * 22e-5) * 0.08),
    (pl.intensity = 2.3 + Math.sin(e * 0.002) * 0.8 + n * 0.42),
    (Wc.position.x += (Zc.x * 30 - Wc.position.x) * 0.036),
    (Wc.position.y += (-Zc.y * 18 - Wc.position.y) * 0.036),
    (Wc.position.z = 116 + Math.sin(e * 6e-4) * 6 - n * 2.4),
    Wc.lookAt(0, 0, -520),
    Gc.render(Uc, Wc);
}
window.addEventListener(`resize`, ml),
  window.addEventListener(`pointermove`, hl, { passive: !0 }),
  document.addEventListener(`visibilitychange`, () => {
    tl = performance.now();
  }),
  window.setInterval(() => {
    document.hidden ||
      performance.now() - nl < 1400 ||
      (cancelAnimationFrame(rl), (tl = performance.now()), _l(tl));
  }, 1e3),
  ml(),
  _l();
var vl = document.querySelector(`#cinematic-loader`),
  yl = window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,
  bl = 4e3,
  xl = !1,
  Sl = 0,
  Cl = 0;
window.__spaceWarpBoost = 0;
function wl(e, t = 0, n = 1) {
...
function El(e, t) {
  vl && vl.style.setProperty(e, t);
}
function Dl(e) {
  let t = Math.min((performance.now() - e) / bl, 1),
    n = Tl(t / 0.86),
    r = Tl((t - 0.78) / 0.22),
    i = Tl((t - 0.91) / 0.09),
    a = Tl((t - 0.18) / 0.68),
    o =
      t < 0.88
        ...
        : 1 - Tl((t - 0.96) / 0.04),
    s = (0.36 + n * 0.52) * (1 - i),
    c = t < 0.2 ? 0 : (0.1 + a * 0.32) * (1 - Tl((t - 0.86) / 0.14)),
    l = t < 0.94 ? 0.14 + n * 0.86 : 1 - Tl((t - 0.94) / 0.06),
    u = 0.045 + n * 1.28 + r * 6.25;
  return (
    El(`--warp-opacity`, s.toFixed(3)),
    El(`--warp-scale`, (0.72 + n * 1.78 + r * 0.64).toFixed(3)),
    El(`--warp-rotate`, `${(t * 70).toFixed(3)}deg`),
    El(`--lens-opacity`, c.toFixed(3)),
    El(`--lens-scale`, (0.2 + a * 1.56 + r * 2.7).toFixed(3)),
    El(`--core-opacity`, Math.max(0, l).toFixed(3)),
    El(`--core-scale`, u.toFixed(3)),
    El(`--flash-opacity`, Math.max(0, o).toFixed(3)),
    El(`--core-glow`, (0.6 + r * 0.4).toFixed(3)),
    (window.__spaceWarpBoost = (n * 0.72 + r * 0.28) * 4.1),
    t
  );
}
function Ol() {
  xl ||
    ...
    (window.__spaceWarpBoost = 0),
    window.dispatchEvent(new CustomEvent(`spcx:site-open`)),
    vl &&
      (vl.classList.add(`is-done`), window.setTimeout(() => vl.remove(), 900)));
}
if (!vl || yl) window.setTimeout(Ol, yl ? 250 : 0);
else {
  let e = performance.now();
  (Sl = window.setTimeout(Ol, 4120)),
    (Cl = window.setInterval(() => {
      Dl(e) >= 1 && Ol();
    }, 16));
  function t() {
    if (Dl(e) < 1) {
...
var kl = document.querySelector(`.forge-title`),
  Al = window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,
  jl = 0;
function Ml() {
  if (
    !kl ||
    Al ||
    kl.classList.contains(`is-forging`) ||
    kl.classList.contains(`is-reversing`)
  )
    return;
  let e = kl.querySelectorAll(`.forge-title__char`),
    t = e.length,
    n = 110 + Math.max(0, t - 1) * 120 + 880,
    r = n + 1180,
    i = r + 80 + Math.max(0, t - 1) * 105 + 860,
    a = window.innerWidth < 720 ? 34 : 58;
  kl.querySelectorAll(`.forge-spark`).forEach((e) => e.remove()),
    kl.classList.remove(`is-forged`, `is-settled`, `is-reversing`, `is-normal`),
    e.forEach((e, n) => {
      e.style.setProperty(`--ri`, String(t - n - 1));
    });
  for (let e = 0; e < a; e += 1) {
    let t = document.createElement(`span`);
    (t.className = `forge-spark`),
      t.style.setProperty(
        `--angle`,
        `${(360 / a) * e + Math.random() * 18}deg`
      ),
      t.style.setProperty(`--distance`, `${42 + Math.random() * 110}px`),
      t.style.setProperty(`--delay`, `${n / 1e3 + Math.random() * 0.18}s`),
      t.style.setProperty(`--duration`, `${0.54 + Math.random() * 0.36}s`),
      t.style.setProperty(`--size`, `${2 + Math.random() * 4}px`),
      kl.appendChild(t);
  }
  kl.classList.add(`is-forging`),
    window.setTimeout(() => {
      kl.classList.add(`is-forged`);
    }, n),
    window.setTimeout(() => {
      kl.classList.add(`is-settled`);
    }, n + 950),
    window.setTimeout(() => {
      kl.classList.remove(`is-forging`, `is-forged`, `is-settled`),
        kl.querySelectorAll(`.forge-spark`).forEach((e) => e.remove()),
        kl.classList.add(`is-reversing`);
    }, r),
    window.setTimeout(() => {
      kl.classList.remove(`is-reversing`, `is-settled`),
        kl.classList.add(`is-normal`);
    }, i);
}
function Nl(e = 0) {
  window.clearTimeout(jl), (jl = window.setTimeout(Ml, e));
}
kl &&
  !Al &&
  (document.body.classList.contains(`is-loading`)
    ? window.addEventListener(`spcx:site-open`, () => Nl(620), { once: !0 })
    : window.addEventListener(`load`, () => Nl(220), { once: !0 }));
var Pl = document.querySelector(`[data-video-feed]`);
if (Pl) {
  let e = Pl.querySelector(`[data-video-player]`),
    t = Pl.querySelector(`[data-video-playlist]`),
    n = Pl.querySelector(`[data-video-title]`),
    r = Pl.querySelector(`[data-video-label]`),
    i = ``,
    a = ``,
    o = 0,
    s = !1;
  ...
  function l(e) {
    return e.map((e) => `${e.id}:${e.src}:${e.size || 0}`).join(`|`);
  }
  function u(a, o = {}) {
    if (!a || !e) return;
    let s = `${a.src}?v=${encodeURIComponent(a.size || a.id)}`,
      l = i === a.id && e.currentSrc.includes(a.src);
    (i = a.id),
      l
        ? e.paused && c()
        : (e.pause(),
          (e.src = s),
          e.load(),
          (o.play || e.autoplay) && e.play().catch(() => {})),
      n && (n.textContent = a.title),
      r && (r.textContent = a.label || `HD`),
      t?.querySelectorAll(`button`).forEach((e) => {
        e.classList.toggle(`is-active`, e.dataset.videoId === a.id);
      });
  }
  function d(e) {
    t &&
      ...
      e.forEach((e, n) => {
        ...
        (r.type = `button`),
          (r.dataset.videoId = e.id),
          (r.className = `video-playlist__item`),
          (a.textContent = e.label || `HD`),
  ...
  async function f() {
    try {
      let e = await fetch(`/assets/videos/videos.json?t=${Date.now()}`, {
        cache: `no-store`,
      });
      if (!e.ok) return;
      let t = await e.json(),
        n = Array.isArray(t.videos) ? t.videos : [];
      if (!n.length) return;
      let r = l(n);
      if (r === a) return;
      (a = r), d(n);
      let c = n.find((e) => e.id === i),
        p = n[0];
      u(s && c ? c : p),
        window.clearInterval(o),
        (o = window.setInterval(f, Math.max(5e3, t.pollInterval || 1e4)));
    } catch {
      window.clearInterval(o), (o = window.setInterval(f, 12e3));
    }
  }
  f(),
    (o = window.setInterval(f, 1e4)),
    e.addEventListener(`canplay`, c),
    e.addEventListener(`ended`, c),
    window.addEventListener(`spcx:site-open`, () => window.setTimeout(c, 500), {
      once: !0,
    }),
    window.setTimeout(c, 1200);
}
var Fl = document.querySelector(`[data-copy-contract]`);
function Il(e) {
...
async function Ll(e) {
  if (!Il(e)) {
    ...
    throw Error(`Copy command was rejected`);
  }
}
if (Fl) {
  let e = Fl.querySelector(`[data-copy-label]`),
    t = e?.textContent || `Contract`;
  Fl.addEventListener(`click`, async () => {
    let n = Fl.dataset.contract;
    if (n)
      try {
        await Ll(n),
          (Fl.dataset.copied = `true`),
          Fl.setAttribute(`aria-label`, `Contract address copied`),
          e && (e.textContent = `Copied`),
          window.setTimeout(() => {
            (Fl.dataset.copied = `false`),
              Fl.setAttribute(`aria-label`, `Copy contract address`),
              e && (e.textContent = t);
          }, 1600);
      } catch {
        Fl.dataset.copied = `false`;
